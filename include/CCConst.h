...
namespace CCCoreLib
{
	...
	[[deprecated( "Use CCCoreLib::RadiansToDegrees()" )]] constexpr double RAD_TO_DEG = ( 180.0 / M_PI );

	//! Conversion factor from degrees to radians
	[[deprecated( "Use CCCoreLib::DegreesToRadians()" )]] constexpr double DEG_TO_RAD = ( M_PI / 180.0 );

	//! Numerical threshold for considering a value as "zero"
	[[deprecated(
		"Use ZERO_TOLERANCE_F/ZERO_TOLERANCE_D or "
		"CCCoreLib::LessThanEpsilon()/CCCoreLib::GreaterThanEpsilon()" )]] constexpr double ZERO_TOLERANCE =
