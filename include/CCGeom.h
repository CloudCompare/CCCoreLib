...
public:
	...
	**/
	inline explicit Vector2Tpl( Type s = 0 )
		: x( s )
		, y( s )
	{
	}
	...
	**/
	inline Vector2Tpl( Type _x, Type _y )
		: x( _x )
		, y( _y )
	{
	}
...
public:
	 ...
	 **/
	inline Tuple3Tpl( Type a, Type b, Type c )
		: x( a )
		, y( b )
		, z( c )
	{
	...
	inline explicit Tuple3Tpl( const Type p[] )
		: x( p[0] )
		, y( p[1] )
		, z( p[2] )
	{
...
public:
	...
	//! Constructor from an array of 3 elements
	inline explicit Vector3Tpl( const Type p[] )
		: Tuple3Tpl<Type>( p )
	{
	}
	...
	{
		return vangle_rad( u, v.u );
	}
	double angle_radd( const Vector3Tpl& v ) const
	{
		return vangle_radd( u, v.u );
	}
...
public:
	...
	/** Inits typle to (a,b,c).
	 **/
	inline Tuple4Tpl( Type a, Type b, Type c, Type d )
		: x( a )
		, y( b )
		, z( c )
		, w( d )
