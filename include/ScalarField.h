	...
	**/
	...
	public:
		...
		**/
		...
		{
			return value == value;
		} //'value == value' fails for NaN values

		//! Sets the value as 'invalid' (i.e. CCCoreLib::NAN_VALUE)
		inline void flagValueAsInvalid( std::size_t index )
		{
			at( index ) = NaN();
		}
		...
		inline ScalarType& getValue( std::size_t index )
		{
			return at( index );
		}
