	...
	**/
	...
	public:
		...
		**/
		...
		//! Returns the best interpolating 2.5D quadric (in the local coordinate system)
		/** Returns an array of the form [a,b,c,d,e,f] such as:
			...
			\return nullptr if computation failed
		**/
		const double* getGlobalQuadric(Tuple3ub* dims = nullptr);
		...
		/** Returns an array of the form [a,b,c,d,e,f] such as:
			...
			\return nullptr if computation failed
		**/
		const PointCoordinateType* getLocalQuadric(Tuple3ub* dims = nullptr);
	...
	protected:
		...
		//! 2.5D Quadric equation (in the Global coordinate system)
		...
		**/
		double m_globalQuadricEquation[6];
