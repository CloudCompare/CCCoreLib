...
namespace CCCoreLib
{
	...
	public:
		...
		**/
		...
		inline PointCoordinateType getSquareSize() const
		{
		...
		**/
		virtual ScalarType computeDistanceFromModelToPoint( const CCVector3* P,
															CCVector3* nearestPoint = nullptr ) const = 0;
